-- Quest step rewards: grant credits when a step completes
--
-- Adds an optional reward_credits column to quest_step_definitions.
-- When evaluate_quest_progress() marks a step complete, it grants
-- the reward to the player's current ship via update_ship_resources().
